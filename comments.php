...
?>
	<div id="comments">
		<h3>
			...
			<?php printf( _n( '1 Person shares his view on %2$s', '%1$s persons share their views on %2$s', $num_comments, 'buddypress' ), number_format_i18n( $num_comments ), '<em>' . get_the_title() . '</em>' ) ?>
		</h3>
